...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df.columns = ['Launch Site', 'class', 'total successful']
        fig = px.pie(filtered_df,
            values='total successful',
            names='Launch Site',
        ...
        fig_title = "Success vs. Failure for " + entered_site
        fig = px.pie(filtered_df,
            values='size',
            names='class',
            title=fig_title    
...
def get_scatter(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df
        filtered_df = filtered_df[filtered_df['Launch Site'] == entered_site]
        fig_title = "Correlation between Payload and Success " + entered_site
        fig = px.scatter(filtered_df, x="Payload Mass (kg)", 
                y="class",
                color="Booster Version Category",
                title=fig_title
